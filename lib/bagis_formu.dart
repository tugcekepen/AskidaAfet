...
class _BilgiAlmaEkraniState extends State<BagisFormu> with FirebaseService {
  ...
  void sendFormToFirebase() {
    ...
    sendFormData(formValues, 'bagis_forms').then((_) {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text('Hata'),
            content:
                Text('Form gönderilirken bir hata oluştu. Tekrar deneyin.'),
            actions: [
              TextButton(
                onPressed: () {
                        ...
                        decoration: InputDecoration(
                          ...
                          focusedBorder: OutlineInputBorder(
                            borderSide: BorderSide(
                                color: Color(
                                    0xFFCF0000)), // Odaklandığında kullanılacak kenarlık rengi
                          ),
                        ),
                      ),
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return AlertDialog(
                                    ...
                                    content: Text(
                                        'Kargo aracı en yakın zamanda adresinize gönderilecek.'),
                                    actions: [
                                      TextButton(
                                        onPressed: () {
                                          Navigator.push(
